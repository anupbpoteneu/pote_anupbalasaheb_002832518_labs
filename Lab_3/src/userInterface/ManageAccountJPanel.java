...
public class ManageAccountJPanel extends javax.swing.JPanel {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if(txtAccountNumber.getText().isEmpty()){
         ...
         JOptionPane.showMessageDialog(null,"Account number u enterd does not exist","Information", JOptionPane.INFORMATION_MESSAGE);
        }
        else{
    ...
    private void btnViewDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewDetailsActionPerformed
        ...
        if(selectedRow < 0){
          ...
          JOptionPane.showMessageDialog(null, "Please select a row from the table to view", "Warning", JOptionPane.WARNING_MESSAGE);
