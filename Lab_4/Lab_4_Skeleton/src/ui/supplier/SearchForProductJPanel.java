...
public class SearchForProductJPanel extends javax.swing.JPanel {
   ...
   Supplier supplier;
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        //Product selectedP = new Product();
        
        boolean rf = false;
        
     for (Product selectedP : supplier.getProductCatalog().getProductCatalog()) {
        if(Integer.parseInt(idField.getText())==(selectedP.getId())) {
               // return selectedP;        
            rf = true;      
            Product P = selectedP;
            ViewProductDetailJPanel vpdjp = new ViewProductDetailJPanel(workArea, P);
        ...
        //return null;
            ...
            if(rf==false){
                ...
                JOptionPane.showMessageDialog(this, "Product not present!");
